...
//        coEvery { mockDataSourceBackend.getCustomerList(any()) } throws BackendException(errorCode = BackendErrorCode.SSLError)
//
//        val actual = repositoryCustomers.getCustomerList(officeBid)
//
...
//        )
//        coEvery { mockDataSourceBackend.getCustomerList(any()) } throws BackendException(errorCode = BackendErrorCode.NoDataChanges)
